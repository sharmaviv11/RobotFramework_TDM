...
Library     BuiltIn
Library     Collections
Resource    resourcefile_minesite.robot
#Test Teardown       Close Browser


*** Test Cases ***
Test Case_1: Validate successful login
    open the browser with dig2design URL
    select your site
...
select your site
    sleep   2s
    wait until element is visible       mat-input-1
    click element                       mat-input-1
#    set selenium timeout    30s
    sleep   2s
#    wait until element is visible      xpath://*[@id="mat-option-8"]/span/div[2]
#    click element                      xpath://*[@id="mat-option-8"]/span/div[2]
    wait until element is visible      mat-option-8
    click element                      mat-option-8
    sleep   2s
#    wait until element is visible       xpath://*[@id="mat-input-2"]
#    click element                       xpath://*[@id="mat-input-2"]
    wait until element is visible       mat-input-2
    click element                       mat-input-2
    sleep   2s
#    wait until element is visible       xpath://*[@id="mat-option-17"]/span/div[2]
#    click element                       xpath://*[@id="mat-option-17"]/span/div[2]
    wait until element is visible       mat-option-17
    click element                       mat-option-17
    sleep   10s
    # zoom into the site
    wait until element is visible       css:canvas
    click element                       css:canvas
    sleep   4s
    # close design details
    wait until element is visible       css:.esri-icon-close
    click element                       css:.esri-icon-close
    sleep   4s
    wait until element is visible       css:.bhp-tool-button-component:nth-child(2) svg
    click element                       css:.bhp-tool-button-component:nth-child(2) svg
    sleep   4s
    wait until element is visible       css:.bhp-tool-button-component:nth-child(3) svg
    click element                       css:.bhp-tool-button-component:nth-child(3) svg
    sleep   4s
    wait until element is visible       css:.bhp-tool-button-component:nth-child(4) svg
    click element                       css:.bhp-tool-button-component:nth-child(4) svg
    sleep   60s
#    wait until element is visible       css:esri-view-surface
#    click element                       css:esri-view-surface
    wait until element is visible       css:.bhp-tool-button-component:nth-child(5) .material-icons-outlined
    click element                       css:.bhp-tool-button-component:nth-child(5) .material-icons-outlined
    sleep   4s
    wait until element is visible       css:.fa-ruler-horizontal
    click element                       css:.fa-ruler-horizontal
    sleep   4s
    wait until element is visible       css:.bhp-tool-button-component:nth-child(7) .material-icons-outlined
    click element                       css:.bhp-tool-button-component:nth-child(7) .material-icons-outlined
    sleep   4s
    wait until element is visible       css:.bhp-tool-button-component:nth-child(8) .material-icons-outlined
    click element                       css:.bhp-tool-button-component:nth-child(8) .material-icons-outlined
    sleep   4s
    wait until element is visible       css:.bhp-tool-button-component:nth-child(9) .material-icons-outlined
    click element                       css:.bhp-tool-button-component:nth-child(9) .material-icons-outlined
    sleep   4s
