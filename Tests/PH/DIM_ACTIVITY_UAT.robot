...
click on the user and switch role to SNOWFLAKE_READER_UAT
        ...
        sleep       3s
        capture page screenshot             ${Activity_Screenshots}/role_2.png
        sleep   3s
        # click change role
        ...
        sleep   3s
        capture page screenshot             ${Activity_Screenshots}/relevant_role.png
        close window
...
#        # search worksheet
        ...
        sleep       2s
        capture page screenshot             ${Activity_Screenshots}/qa_sql.png
        sleep   2s
        ...
        sleep       2s
        capture page screenshot             ${Activity_Screenshots}/qa_sql_download.png
        sleep       2s
        ...
        sleep   4s
        # close worksheet
        wait until element is enabled       css:#\+-copy
        click button                        css:#\+-copy
...
#        click element                       xpath://*[@id="sleet-component-1187"]/div/div/div[2]/div[2]/div[1]/div[1]/div/div[1]/div[2]/button/img
#        sleep       2s
#        capture page screenshot             ${Activity_Screenshots}/conformed_sql.png
#        sleep   2s
#        # click on download button
#        wait until element is enabled       xpath://*[@id="sql-worksheet-result-pane-content"]/div[3]/div/div[1]/div[2]/button
#        click element                       xpath://*[@id="sql-worksheet-result-pane-content"]/div[3]/div/div[1]/div[2]/button
...
#        click element                       xpath://*[@id="ext-element-1"]/div[5]/div/div/div/div[2]/div/div[1]/button
#        sleep       2s
#        capture page screenshot             ${Activity_Screenshots}/conformed_sql_download.png
#        # click into text area and copy results
#        scroll element into view            xpath://*[@id="ext-element-1"]/div[5]/div/div/div/div[2]/div
#        set focus to element                xpath://*[@id="ext-element-1"]/div[5]/div/div/div/div[2]/div
#        wait until element is enabled       xpath://*[@id="ext-element-1"]/div[5]/div/div/div/div[2]/div
